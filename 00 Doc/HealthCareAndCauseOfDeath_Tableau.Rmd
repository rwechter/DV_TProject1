...
We modified the R script given to us to create a SQL code that would create the table in the Oracle Database from previous assignments.  We then loaded our data and could connect to the database to create our data frame in RStudio.

```{r}
setwd("~/DataVisualization/DV_TProject1/01 Data")

file_path <- "US_AGGREGATE09.CSV.reformatted.csv"
...
file_path <- "LeadingCausesStateYear.csv"
